...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-8 text-left">
            ...
            <h2 class="title">專書論文／Book Chapters </h2>
            <p></p>
            <div class="entry">
                <table width="95%" border="0" cellpadding="0" cellspacing="0" class="tb_main">
                    <tr class="odd">
                        <td width="5%">1</td>
                        <td>時文中(Wen-Chung Shih)，The New Faces of Organizations in the 21st Century<br> The Content-Based Face of Organizations<br>，2011.</td>
                    </tr>
                    <tr>
                        <td width="5%">2</td>
                        <td>時文中(Wen-Chung Shih)，Web 2.0: The Business Model<br> Teaching-Material Crystallization: Wiki-based Rapid Prototyping for Teaching-Material Design<br>，2008.10</td>
                    </tr>
                </table>
                <p>&nbsp;</p>
            </div>
